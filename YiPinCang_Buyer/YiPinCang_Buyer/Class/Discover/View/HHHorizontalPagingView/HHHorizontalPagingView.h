 ...
 *  更改头部视图高度
 */
@property (nonatomic, assign) CGFloat heraderHeight;
/**
 *  更改头部视图内容
 */
@property (nonatomic, strong) UIView *nHearderView;
 ...
 *  相机按钮的回调block
 */
@property (nonatomic, copy) void (^takePhotoBtnBlock)(NSInteger index);
 ...
 *  更新frame
 */
- (void)updateFramepagingViewWithHeaderView:(UIView *)headerView
                               headerHeight:(CGFloat)headerHeight;
/**
 *  手动控制滚动到某个视图
 *
