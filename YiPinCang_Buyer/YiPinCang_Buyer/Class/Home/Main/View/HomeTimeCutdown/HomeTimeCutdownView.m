...
@property (strong, nonatomic) IBOutlet UIImageView *SecondImgV1;
@property (strong, nonatomic) IBOutlet UIImageView *SecondImgV2;

@end

@implementation HomeTimeCutdownView

- (void)awakeFromNib
{
    [super awakeFromNib];
    [[NSBundle mainBundle] loadNibNamed:@"HomeTimeCutdownView" owner:self options:nil];
...
- (void)setColorStyle:(SecondColorStyle)colorStyle
{
    _colorStyle = colorStyle;
    if (_colorStyle == SecondColorStyleRed) {
        self.SecondImgV1.image = IMAGE(@"homepage_countdown_bg_second_video playing");
        self.SecondImgV2.image = IMAGE(@"homepage_countdown_bg_second_video playing");
    }else if (_colorStyle == SecondColorStyleGreen) {
        self.SecondImgV1.image = IMAGE(@"homepage_countdown_bg_second_advance notice");
        self.SecondImgV2.image = IMAGE(@"homepage_countdown_bg_second_advance notice");
    }
}
